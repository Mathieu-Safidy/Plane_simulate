    ...
    <tr>
        ...
        <% for(Vols vol : vols) { %>
            <tr>
                ...
                <td><%=vol.getAvion().getModel().getNom() %></td>
                <td><a href="update/form?id_vols=<%=vol.getIdVols() %>" class="button button-sm button-secondary button-nina">Update</a></td>
                <td><a href="delete?id_vols=<%=vol.getIdVols() %>" class="button button-sm button-secondary button-nina">Delete</a></td>
            </tr>
        <% } %>
</table>

<%@page import="entity.event.VDetailVolsDispo" %>
  <%@page import="java.util.List,java.util.ArrayList" %>
    <% List<VDetailVolsDispo>
      vols = (List<VDetailVolsDispo>)request.getAttribute("vols"); String idvol =
        (String)request.getAttribute("idvols"); String message = "";
        if(request.getParameter("message") != null) { message =
        ...
        <head>
          ...
          >
            <a href="http://windows.microsoft.com/en-US/internet-explorer/"
              ><img
                src="<%=request.getContextPath() %>/assets/images/ie8-panel/warning_bar_0000_us.jpg"
                border="0"
                height="42"
                width="820"
        ...
        <body>
          ...
          <div class="page">
            <a class="section section-banner text-center d-none d-xl-block"
              href="https://www.templatemonster.com/intense-multipurpose-html-template.html" style="
              background-image: url(<%=request.getContextPath()%>/assets/images/banner/background-04-1920x60.jpg);
              background-image: -webkit-image-set(
                url(<%=request.getContextPath()%>/assets/images/banner/background-04-1920x60.jpg)
                  1x,
                url(<%=request.getContextPath()%>/assets/images/banner/background-04-3840x120.jpg)
                  2x
              );
            "><img src="<%=request.getContextPath() %>/assets/images/banner/foreground-04-1600x60.png"
            ...
            <header
                    ...
                    <div class="rd-navbar-panel">
                      ...
                      <div class="rd-navbar-brand">
                        <a class="brand-name" href="index.html"><img class="logo-default"
                            src="<%=request.getContextPath() %>/assets/images/logo-default-208x46.png" alt width="208"
                            height="46" /><img class="logo-inverse"
                            src="<%=request.getContextPath() %>/assets/images/logo-inverse-208x46.png" alt width="208"
                            height="46" /></a>
                      </div>
                    </div>
              ...
              <!-- Breadcrumbs-->
              <section class="breadcrumbs-custom" style="
                background: url('<%=request.getContextPath() %>/assets/images/breadcrumbs-bg.jpg');
                    ...
                    <div class="col-lg-8 offset-lg-2 col-xl-7 offset-xl-2">
                      <div class="section-wrap-content section-lg">
                        ...
                        <p class="big">
                          ...
                          We are available 24/7 via fax or email. You can also use
                          a quick contact form below or visit our office
                          personally.
                        </p>
                        <% if (!message.isEmpty()) { %>
                          ...
                          <% } %>
                            ...
                            <form class="rd-mailform" data-form-output="form-output-global" data-form-type="contact"
                              method="post" action="reserver" enctype="multipart/form-data">
                              <div class="row row-fix row-20">
                                <div class="col-sm-12">
                                  <label class="form-label-outside">To</label>
                                  <div class="form-wrap form-wrap-inline">
                                    <select class="form-input select-filter" data-placeholder="All"
                                      data-minimum-results-for-search="Infinity" name="filtre_idType">
                                      <% for(VDetailVolsDispo vol : vols) { %>
                                        <option value="<%=vol.getSiegeDetail().getIdType() %>">
                                ...
                                <!-- <div class="col-lg-6">
                                  <label class="form-label-outside">Nombre de billet</label>
                                  <div class="form-wrap form-wrap-modern">
                                    <input class="form-input input-append" id="form-element-stepper" type="number"
                                      min="0" value="1" name="filtre_place" />
                                  </div>
                                </div> -->

                                <div class="col-lg-6">
                                  <label class="form-label-outside">Nombre de billet adult </label>
                                  <div class="form-wrap form-wrap-modern">
                                    <input class="form-input input-append" id="form-element-stepper" type="number"
                                      min="0" value="1" name="filtre_placeAdult" />
                                  </div>
                                </div>

                                <div class="col-lg-6">
                                  <label class="form-label-outside">Nombre de billet enfant</label>
                                  <div class="form-wrap form-wrap-modern">
                                    <input class="form-input input-append" id="form-element-stepper" type="number"
                                      min="0" value="1" name="filtre_placeEnfant" />
                                  </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                  ...
                                  <input class="form-input" id="dateForm" type="datetime-local"
                  ...
                  <div class="col-sm-6 col-lg-3">
                    ...
                    <article class="box-simple">
                      ...
                      <div class="box-simple-text">
                        <a href="#">2130 Fulton Street, Chicago, IL <br />
                          94117-1080 USA</a>
                      </div>
                    </article>
                  </div>
            ...
            <a class="section section-banner"
              href="https://www.templatemonster.com/intense-multipurpose-html-template.html" style="
              background-image: url(<%=request.getContextPath()%>/assets/images/banner/background-03-1920x310.jpg);
              background-image: -webkit-image-set(
                url(<%=request.getContextPath()%>/assets/images/banner/background-03-1920x310.jpg)
                  1x,
                url(<%=request.getContextPath()%>/assets/images/banner/background-03-3840x620.jpg)
                  2x
              );
            "><img src="<%=request.getContextPath() %>/assets/images/banner/foreground-03-1600x310.png"
                ...
                <div class="row row-fix justify-content-sm-center align-items-md-center row-30">
                  ...
                  <div class="col-md-10 col-lg-7 col-xl-4">
                    <p class="right">
                      ...
                      Reserved. Design&nbsp;by&nbsp;<a href="https://www.templatemonster.com">TemplateMonster</a>
                    </p>
                  </div>
                  <div class="col-md-10 col-lg-7 col-xl-4 text-xl-right">
                    <ul class="group-xs group-middle">
                      <li>
                        <a class="icon novi-icon icon-md-middle icon-circle icon-secondary-5-filled mdi mdi-facebook"
                          href="#"></a>
                      </li>
                      <li>
                        <a class="icon novi-icon icon-md-middle icon-circle icon-secondary-5-filled mdi mdi-twitter"
                          href="#"></a>
                      </li>
                      <li>
                        <a class="icon novi-icon icon-md-middle icon-circle icon-secondary-5-filled mdi mdi-instagram"
                          href="#"></a>
                      </li>
                      <li>
                        <a class="icon novi-icon icon-md-middle icon-circle icon-secondary-5-filled mdi mdi-google"
                          href="#"></a>
                      </li>
                      <li>
                        <a class="icon novi-icon icon-md-middle icon-circle icon-secondary-5-filled mdi mdi-linkedin"
                          href="#"></a>
                      </li>
                    </ul>
                  </div>
